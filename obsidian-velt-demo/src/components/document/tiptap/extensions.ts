  ...
  renderHTML({ HTMLAttributes }) {
    return [
      ...
      mergeAttributes(HTMLAttributes, {
        "data-heading": "h1",
        style:
          "font-family: Urbanist, sans-serif; font-size: 32px; font-weight: 700; line-height: 1.5;",
      }),
      0,
    ];
  },
  ...
  renderHTML({ HTMLAttributes }) {
    return [
      ...
      mergeAttributes(HTMLAttributes, {
        "data-heading": "h2",
        style:
          "font-family: Urbanist, sans-serif; font-size: 20px; font-weight: 700; line-height: 1.5;",
      }),
      0,
    ];
  },
  ...
  renderHTML({ HTMLAttributes }) {
    return [
      ...
      mergeAttributes(HTMLAttributes, {
        "data-heading": "h3",
        style:
          "font-family: Urbanist, sans-serif; font-size: 16px; font-weight: 700; line-height: 1.5;",
      }),
      0,
    ];
  },
